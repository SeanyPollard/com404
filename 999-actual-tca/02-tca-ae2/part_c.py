...
class Gui(Tk):
    ...
    def __add_animation_button(self):
        ...
        self.animation_button.grid(row=5, column=0, columnspan=2)
    ...
    def __add_reverse_button(self):
        ...
        self.reverse_button.grid(row=6, column=0, columnspan=2, pady=(0,5))
    ...
    def __add_animation_frame(self):
        self.animation_frame = Frame(self.global_frame)
        self.animation_frame.grid(row=7, column=0, columnspan=2)
        self.animation_frame.configure(height=200, width=370)
    ...
    def tick(self):
        if self.animation == TRUE:
            if self.reverse == FALSE:
                ...
                if self.animation_x_pos == 290 and self.animation_y_pos == 20:
                    self.animation_x_change = 0
                    self.animation_y_change = 1
                if self.animation_x_pos == 290 and self.animation_y_pos == 120:
                    self.animation_x_change = -1
                    self.animation_y_change = 0
                if self.animation_x_pos == 20 and self.animation_y_pos == 120:
                    self.animation_x_change = 0
                    self.animation_y_change = -1
